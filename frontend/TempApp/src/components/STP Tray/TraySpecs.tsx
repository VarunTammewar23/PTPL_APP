// src/components/RT Angle/TraySpecs.tsx
import React, {
  useEffect,
  useMemo,
  useState,
...
function TraySpecsInner(
  ...
  const imgSrc = imageUri ? { uri: imageUri } : require('../../assets/TraySpecs.jpg');
...
export default React.forwardRef(TraySpecsInner);