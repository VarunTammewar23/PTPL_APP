// src/components/RT Angle/GapSetting.tsx
import React, {
  useEffect,
  useMemo,
  useState,
...
const PARAM_SR = [91,99,101,90,92,94];
...
function GapSettingInner(
  ...
  const imgSrc = imageUri ? { uri: imageUri } : require('../../assets/GapSetting.jpg');
...
export default React.forwardRef(GapSettingInner);