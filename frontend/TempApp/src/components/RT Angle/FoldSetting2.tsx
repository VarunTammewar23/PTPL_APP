// src/components/RT Angle/FoldSetting2.tsx
import React, {
  useEffect,
  useMemo,
  useState,
...
function FoldSetting2Inner(
  ...
  const imgSrc = imageUri ? { uri: imageUri } : require('../../assets/FoldSetting2.jpg');
...
export default React.forwardRef(FoldSetting2Inner);