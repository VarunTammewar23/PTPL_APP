// src/components/RT Angle/FoldSetting.tsx
import React, {
  useEffect,
  useMemo,
  useState,
...
function FoldSettingInner(
  ...
  const imgSrc = imageUri ? { uri: imageUri } : require('../../assets/FoldSettings.jpg');
...
modalTable: {
  ...
  modalTitle: { fontSize: POPUP.TABLE.titleFont, fontWeight: '700', marginBottom: 10 },
...
export default React.forwardRef(FoldSettingInner);